...
enum GameMessages
{
	ID_CHOOSE_CARD = ID_USER_PACKET_ENUM + 1,
	ID_CHOOSE_WINNER = ID_USER_PACKET_ENUM + 2,
	ID_START_ROUND = ID_USER_PACKET_ENUM + 3,
	ID_RECEIVE_CARD = ID_USER_PACKET_ENUM + 4,
	ID_RECEIVE_QUESTION_CARD = ID_USER_PACKET_ENUM + 5,
	ID_COLLECT_ANSWER_CARDS = ID_USER_PACKET_ENUM + 6,
	ID_ADD_SCORE = ID_USER_PACKET_ENUM + 7,
	ID_SHOW_SCORE = ID_USER_PACKET_ENUM + 8,
	ID_BECOME_ASKER = ID_USER_PACKET_ENUM + 9,
	ID_WIN_GAME = ID_USER_PACKET_ENUM + 10,
	ID_BROADCAST_MESSAGE = ID_USER_PACKET_ENUM + 11
};
